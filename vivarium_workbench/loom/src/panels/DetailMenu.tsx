...
export default function DetailMenu(props: {
  ...
  const anyForced = overrides.ports !== 'auto' || overrides.stores !== 'auto'
    ...
    || overrides.address !== 'auto' || overrides.direction !== 'off';
  ...
  const rowLabel: React.CSSProperties = { fontSize: 11.5, color: '#374151', width: 72, flexShrink: 0 };
    ...
    <div ref={wrapRef} style={{ position: 'relative' }}>
      ...
      {open && (
        <div style={{
          ...
          <div style={row}><span style={rowLabel}>Read/write</span>{seg(TRI, overrides.direction, (id) => setOverrides({ ...overrides, direction: id as TriDetail }))}</div>
