...
def test_intervention_add_appends(_study_ws):
    from vivarium_workbench.lib.study_crud_mutations import study_intervention_add as _post_study_intervention_add_for_test
...
def test_intervention_update_404_unknown(_study_ws):
    from vivarium_workbench.lib.study_crud_mutations import study_intervention_update as _post_study_intervention_update_for_test
    resp, code = _post_study_intervention_update_for_test(
...
def test_intervention_delete_404_unknown(_study_ws):
    from vivarium_workbench.lib.study_crud_mutations import study_intervention_delete as _post_study_intervention_delete_for_test
    resp, code = _post_study_intervention_delete_for_test(
