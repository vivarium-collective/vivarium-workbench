...
from vivarium_dashboard.lib import viz_core as _viz_core
...
class Handler(BaseHTTPRequestHandler):
    ...
    def _build_workspace_core(self):
        return _viz_core.build_workspace_core(WORKSPACE)

    def _add_workspace_viz_classes(self, registry):
        return _viz_core.add_workspace_viz_classes(WORKSPACE, registry)

    def _resolve_viz_class(self, address):
        return _viz_core.resolve_viz_class(WORKSPACE, address)

    def _demo_state_for(self, cls, class_key):
        return _viz_core.demo_state_for(cls, class_key)
    ...
    def _uninstall_unmanaged_or_404(self, name: str):
        return self._json(*_catalog_uninstall_views.uninstall_unmanaged_or_404(WORKSPACE, name))
